 ...
 * <p>Usage:
 * <pre>
 * Image avatar = ImageCache.getAvatar("/photos/user123.jpg", 64);
 * Image profile = ImageCache.getImage("/photos/user123.jpg", 200, 200);
 * </pre>
 */
public final class ImageCache {
     ...
     * Simple strategy - just remove first entry found.
     */
