...
public class ProfileHandler {
    ...
    public ProfileHandler(UserStorage userStorage, ProfilePreviewService profilePreviewService,
            AchievementService achievementService, UserSession userSession, InputReader inputReader) {
