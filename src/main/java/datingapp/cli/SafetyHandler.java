...
public class SafetyHandler {
    ...
    public SafetyHandler(UserStorage userStorage, BlockStorage blockStorage, MatchStorage matchStorage,
            ReportService reportService, UserSession userSession, InputReader inputReader) {
