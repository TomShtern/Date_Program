 ...
 *
 * <p>Messages are validated on construction: content cannot be empty or exceed 1000 characters.
 */
public record Message(
    UUID id, String conversationId, UUID senderId, String content, Instant createdAt) {
