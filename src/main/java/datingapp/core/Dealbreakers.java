 ...
 * Candidates who don't meet these criteria will be excluded from matching.
 *
 * <p>
 * Dealbreakers are one-way: if I have a dealbreaker against smokers,
 * I won't see smokers, but smokers can still see me (unless they have their own
 * dealbreakers).
 */
