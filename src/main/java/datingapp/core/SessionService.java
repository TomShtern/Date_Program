...
/**
 * Service for managing swipe sessions.
 * Handles session lifecycle (create, update, end) and anti-bot detection.
 */
public class SessionService {
     ...
     * If existing session is timed out, ends it and creates a new one.
     *
