...
/**
 * Represents a user's swiping session.
 * A session tracks continuous swiping activity with metrics like swipe count,
 * like ratio, and velocity (swipes per minute).
 *
 * <p>
 * Sessions are mutable (unlike Like/Match) because they're updated frequently
