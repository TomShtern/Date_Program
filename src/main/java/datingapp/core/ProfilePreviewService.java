...
public class ProfilePreviewService {
  ...
  public record ProfileCompleteness(
      int percentage, List<String> filledFields, List<String> missingFields) {
  ...
  public ProfileCompleteness calculateCompleteness(User user) {
    ...
    checkField(
        "Interests", user.getInterests().size() >= Interest.MIN_FOR_COMPLETE, filled, missing);
  ...
  private void checkField(
      String fieldName, boolean isFilled, List<String> filled, List<String> missing) {
    if (isFilled) {
