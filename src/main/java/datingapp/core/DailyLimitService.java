...
/**
 * Service to track and enforce daily like/pass limits.
 * Limits reset at midnight in the configured user timezone.
 */
public class DailyLimitService {
    ...
    /**
     * Check if user can pass (has remaining daily passes).
     * Usually unlimited (returns true).
     */
