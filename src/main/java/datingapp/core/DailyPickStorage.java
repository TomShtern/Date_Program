...
/**
 * Storage interface for tracking when users view their daily picks. Enables persistence of view
 * history to prevent showing the same pick multiple times after it's been acted upon.
 */
public interface DailyPickStorage {
  ...
  /**
   * Remove view records older than a specified date. Used for cleanup/maintenance to prevent table
   * bloat.
   *
