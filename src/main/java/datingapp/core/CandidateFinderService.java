...
/**
 * Interface for finding candidate users for matching.
 * Allows drop-in replacement with different matching strategies.
 */
public interface CandidateFinderService {
     ...
     * @param excluded  Set of user IDs to exclude (already interacted, blocked,
     *                  etc.)
