...
public class H2UserStorage implements UserStorage {
  ...
  private Dealbreakers mapDealbreakers(ResultSet rs) throws SQLException {
    ...
    Set<Lifestyle.Drinking> dbDrinking =
        parseEnumSet(rs.getString("db_drinking"), Lifestyle.Drinking.class);
    Set<Lifestyle.WantsKids> dbKids =
        parseEnumSet(rs.getString("db_wants_kids"), Lifestyle.WantsKids.class);
