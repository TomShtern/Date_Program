    ...
    class ValidationTests {
        ...
        void validMatchQualityCreated() {
            MatchQuality quality = new MatchQuality(
                    MATCH_ID, USER_A, USER_B, Instant.now(),
                    0.8, 0.9, 0.5, 0.7, 0.6,
                    10.5, 5,
                    List.of("Hiking"), List.of("Both non-smokers"),
                    Duration.ofHours(2),
                    75, List.of("Great match"));
        ...
        void throwsOnNullMatchId() {
            assertThrows(NullPointerException.class, () -> new MatchQuality(
                    null, USER_A, USER_B, Instant.now(),
                    0.8, 0.9, 0.5, 0.7, 0.6,
                    10.5, 5, List.of(), List.of(),
                    Duration.ZERO, 75, List.of()));
        }

        @Test
        @DisplayName("Throws if score above 1.0")
        void throwsIfScoreAboveOne() {
            assertThrows(IllegalArgumentException.class, () -> new MatchQuality(
                    MATCH_ID, USER_A, USER_B, Instant.now(),
                    1.5, 0.9, 0.5, 0.7, 0.6, // distance score > 1.0
                    10.5, 5, List.of(), List.of(),
                    Duration.ZERO, 75, List.of()));
        }
        ...
        void throwsIfScoreBelowZero() {
            assertThrows(IllegalArgumentException.class, () -> new MatchQuality(
                    MATCH_ID, USER_A, USER_B, Instant.now(),
                    -0.1, 0.9, 0.5, 0.7, 0.6, // distance score < 0.0
                    10.5, 5, List.of(), List.of(),
                    Duration.ZERO, 75, List.of()));
        }
        ...
        void nullListsBecomeEmpty() {
            MatchQuality quality = new MatchQuality(
                    MATCH_ID, USER_A, USER_B, Instant.now(),
                    0.8, 0.9, 0.5, 0.7, 0.6,
                    10.5, 5, null, null, Duration.ZERO, 75, null);
    ...
    class DisplayTests {
        ...
        void getShortSummaryReturnsFirstHighlight() {
            MatchQuality quality = new MatchQuality(
                    ...
                    0.8, 0.9, 0.5, 0.7, 0.6,
                    10.5, 5, List.of(), List.of(),
                    Duration.ZERO, 75, List.of("First highlight", "Second"));
        ...
        void getShortSummaryTruncatesLong() {
            String longHighlight = "This is a very long highlight that exceeds forty characters and should be truncated";
            MatchQuality quality = new MatchQuality(
                    MATCH_ID, USER_A, USER_B, Instant.now(),
                    0.8, 0.9, 0.5, 0.7, 0.6,
                    10.5, 5, List.of(), List.of(),
                    Duration.ZERO, 75, List.of(longHighlight));
