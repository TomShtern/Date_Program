...
class CandidateFinderTest {
    ...
    void filtersByMutualGenderPreferences() {
        ...
        User incompatible = createUser("Incompatible", User.Gender.FEMALE, EnumSet.of(User.Gender.FEMALE), 28, 32.0,
                34.0);
    ...
    private User createUser(String name, User.Gender gender, Set<User.Gender> interestedIn, int age, double lat,
            double lon) {
