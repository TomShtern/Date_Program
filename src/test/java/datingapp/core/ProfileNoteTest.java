...
class ProfileNoteTest {
  ...
  class Create {
    ...
    void throwsOnBlankContent() {
      assertThrows(
          IllegalArgumentException.class, () -> ProfileNote.create(AUTHOR, SUBJECT, "   "));
    }
    ...
    void throwsIfContentExceedsMaxLength() {
      ...
      IllegalArgumentException ex =
          assertThrows(
              IllegalArgumentException.class, () -> ProfileNote.create(AUTHOR, SUBJECT, tooLong));
    ...
    void throwsIfAuthorEqualsSubject() {
      assertThrows(
          ...
          () -> ProfileNote.create(AUTHOR, AUTHOR, "note about myself"));
    }
  }
