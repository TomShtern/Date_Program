...
class LikerBrowserServiceTest {
  ...
  void filtersCorrectly() {
    ...
    LikerBrowserService service =
        new LikerBrowserService(likeStorage, userStorage, matchStorage, blockStorage);
  ...
  void ordersByLikedAtDesc() {
    ...
    List<LikerBrowserService.PendingLiker> pending =
        service.findPendingLikersWithTimes(currentUserId);
