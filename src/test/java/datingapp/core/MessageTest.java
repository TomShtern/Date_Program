...
class MessageTest {
  ...
  class MessageValidation {
    ...
    void rejectNullContent() {
      assertThrows(
          IllegalArgumentException.class, () -> Message.create(CONVERSATION_ID, SENDER_ID, null));
    }
    ...
    void rejectEmptyContent() {
      assertThrows(
          IllegalArgumentException.class, () -> Message.create(CONVERSATION_ID, SENDER_ID, ""));
    }
    ...
    void rejectTooLongContent() {
      ...
      IllegalArgumentException ex =
          assertThrows(
              ...
              () -> Message.create(CONVERSATION_ID, SENDER_ID, content));
