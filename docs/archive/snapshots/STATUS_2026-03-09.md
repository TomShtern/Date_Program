...
The database schema (`SchemaInitializer.java`) dictates the true capabilities of the system. There are 26 active tables (including normalized profile tables) handling the domain definitions:
